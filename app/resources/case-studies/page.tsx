...
export const metadata = { title: "Case Studies — SoloBuildAI Resources" };
    ...
    <PageLayout>
      <section className="min-h-[80vh] flex items-center justify-center py-24 px-6">
        <div className="max-w-lg text-center">
          ...
          <h1 className="text-4xl md:text-5xl font-semibold text-slate-900 mb-5 tracking-tight">Case Studies</h1>
          <p className="text-slate-500 text-base leading-relaxed mb-10">
            Real-world deployment stories showing how SoloBuildAI is solving operational problems
            for organizations. Case studies will be published as deployments are validated.
          </p>
