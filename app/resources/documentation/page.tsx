...
export const metadata = { title: "Documentation — SoloBuildAI Resources" };
    ...
    <PageLayout>
      <section className="min-h-[80vh] flex items-center justify-center py-24 px-6">
        <div className="max-w-lg text-center">
          ...
          <h1 className="text-4xl md:text-5xl font-semibold text-slate-900 mb-5 tracking-tight">Documentation</h1>
          <p className="text-slate-500 text-base leading-relaxed mb-10">
            Integration guides, API references, and setup documentation for SoloBuildAI products.
            Full documentation is being prepared and will be available soon.
          </p>
