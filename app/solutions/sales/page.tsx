      ...
      <section className="min-h-[80vh] flex items-center justify-center py-24 px-6">
        <div className="max-w-lg text-center">
          ...
          <p className="text-slate-500 text-base leading-relaxed mb-10">
            We&apos;re exploring practical AI systems for sales workflows — intelligent outreach,
            pipeline management, and conversation intelligence. Tell us what problem you&apos;re
            trying to solve and we&apos;ll keep you informed.
          </p>
