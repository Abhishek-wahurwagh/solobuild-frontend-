...
// ─── Same visual language as /solutions/ai-for-hr ────────────────────────────
// This is the canonical /solutions/hr route.
// Talent Acquisition now links to /solutions/hr/talent-acquisition.
...
const workflows = [
  {
    ...
    description: "Find, screen and hire the best talent with AI agents.",
    plugins: "10 plugins",
  ...
  },
  {
    ...
    description: "Turn new hires into productive employees, faster.",
    plugins: "9 plugins",
  ...
  },
  {
    ...
    description: "Personalised growth and skill development at scale.",
    plugins: "8 plugins",
  ...
  },
  {
    ...
    description: "Continuous feedback for high-performing teams.",
    plugins: "7 plugins",
    integrations: "4 integrations",
    href: "/solutions/hr",
    icon: "chart",
  },
  {
    ...
    description: "Simplify payroll, benefits and compensation.",
    plugins: "10 plugins",
  ...
  },
  {
    ...
    description: "Instant answers to employee questions, around the clock.",
    plugins: "11 plugins",
  ...
  {
    title: "Offboarding",
    description: "Ensure a secure and seamless offboarding process.",
    plugins: "6 plugins",
    integrations: "4 integrations",
    href: "/solutions/hr",
    icon: "exit",
...
const integrations = [
  ...
  "Google Workspace", "Microsoft 365", "SAP", "ADP", "+ More",
];
...
function IntegrationLogo({ name }: { name: string }) {
  ...
  if (name === "SAP")              return <svg {...c} style={{ color: "#008FD3" }}><path d="M4 5h16v14H4z" /><path d="M7 15V9h2.5a2 2 0 1 1 0 4H7m7 2V9h2.2a1.8 1.8 0 1 1 0 3.6H14m0 0h3" /></svg>;
...
function WorkflowCard({ workflow }: { workflow: typeof workflows[number] }) {
  const isLive = "live" in workflow && workflow.live;
  return (
    <Link
      href={workflow.href}
      ...
      <div className="mb-6 flex items-start justify-between">
        <div className="flex h-10 w-10 items-center justify-center rounded-lg border border-white/10 text-[#0066FF]">
          <svg aria-hidden className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
            <path strokeLinecap="round" strokeLinejoin="round" d={ICON_PATHS[workflow.icon]} />
          </svg>
        </div>
          ...
          <div className="grid min-h-[650px] grid-cols-1 lg:grid-cols-[0.95fr_1.05fr]">
            ...
            <div className="flex flex-col justify-between p-7 sm:p-10 lg:p-14">
              <div>
                ...
                <h1 className="mt-8 max-w-[540px] text-5xl font-medium leading-[0.98] tracking-[-0.04em] text-white sm:text-6xl lg:text-[72px]">
                ...
                <p className="mt-7 max-w-[470px] text-base leading-relaxed text-white/50">
                  AI agents to automate the entire employee lifecycle — from hiring and onboarding
                  to development, payroll and beyond.
                </p>
            ...
            <div className="relative min-h-[440px] overflow-hidden border-t border-white/10 lg:border-l lg:border-t-0">
              <Image
                ...
                alt="People working with SoloBuildAI"
                fill
                priority
        ...
        <section id="workflows" className="rounded-2xl border border-white/10 bg-[#070707] p-7 sm:p-10 lg:p-14">
          <div className="flex flex-col justify-between gap-8 border-b border-white/10 pb-10 lg:flex-row lg:items-end">
            ...
            <p className="max-w-[300px] text-sm leading-relaxed text-white/45 lg:text-right">
              From hiring to retirement — a complete HR operating system powered by AI agents.
            </p>
          </div>

          <div className="mt-8 grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
            {workflows.slice(0, 4).map((w) => <WorkflowCard key={w.title} workflow={w} />)}
            {workflows.slice(4).map((w) => <WorkflowCard key={w.title} workflow={w} />)}
            {/* Promo tile */}
            <div className="relative min-h-[242px] overflow-hidden rounded-xl border border-[#0066FF]/45 bg-[#0066FF]/[0.08] p-5">
              ...
              <p className="relative mt-8 text-[11px] uppercase tracking-[0.18em]" style={{ color: BRAND }}>
