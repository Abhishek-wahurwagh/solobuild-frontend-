      ...
      <section className="min-h-[80vh] flex items-center justify-center py-24 px-6">
        <div className="max-w-lg text-center">
          ...
          <p className="text-slate-500 text-base leading-relaxed mb-10">
            We&apos;re exploring practical AI systems for operational workflows — AI that understands
            how your organization works, surfaces bottlenecks, and automates the repetitive parts
            so your team focuses on decisions that require human judgment.
          </p>
