...
export const metadata = { title: "Workflow Automation — SoloBuildAI Platform" };
    ...
    <PageLayout>
      <section className="min-h-[80vh] flex items-center justify-center py-24 px-6">
        <div className="max-w-lg text-center">
          ...
          <h1 className="text-4xl md:text-5xl font-semibold text-slate-900 mb-5 tracking-tight">Workflow Automation</h1>
          <p className="text-slate-500 text-base leading-relaxed mb-10">
            Automate multi-step operational processes with AI that understands context, accesses
            your tools, and makes intelligent decisions — while keeping humans in control at key moments.
