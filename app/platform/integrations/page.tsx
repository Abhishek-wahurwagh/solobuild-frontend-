...
export const metadata = { title: "Integrations — SoloBuildAI Platform" };
    ...
    <PageLayout>
      <section className="min-h-[80vh] flex items-center justify-center py-24 px-6">
        <div className="max-w-lg text-center">
          ...
          <h1 className="text-4xl md:text-5xl font-semibold text-slate-900 mb-5 tracking-tight">Integrations</h1>
          <p className="text-slate-500 text-base leading-relaxed mb-10">
            Connect SoloBuildAI to your existing tools and data sources. Full integration
            documentation — covering ATS, CRM, calendar, and communication platforms — coming soon.
          </p>
