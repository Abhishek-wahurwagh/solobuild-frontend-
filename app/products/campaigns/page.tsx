...
export const metadata = { title: "Campaigns — SoloBuildAI Products" };
    ...
    <PageLayout>
      <section className="min-h-[80vh] flex items-center justify-center py-24 px-6">
        <div className="max-w-lg text-center">
          ...
          <h1 className="text-4xl md:text-5xl font-semibold text-slate-900 mb-5 tracking-tight">Campaigns</h1>
          <p className="text-slate-500 text-base leading-relaxed mb-10">
            Manage outbound AI campaigns at scale — for hiring, sales, or customer engagement.
            Multi-channel campaign orchestration with AI execution and real-time reporting.
